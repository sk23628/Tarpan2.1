...
public class DiskBasedCacheTest {
    ...
    @Test public void cacheHeaderSerialization() throws Exception {
        ...
        DiskBasedCache.CacheHeader first = new DiskBasedCache.CacheHeader("my-magical-key", e);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        first.writeHeader(baos);
        ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
        DiskBasedCache.CacheHeader second = DiskBasedCache.CacheHeader.readHeader(bais);
